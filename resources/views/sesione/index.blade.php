                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('sesiones.destroy', $sesione->id) }}" method="POST">
                                                <a class="btn btn-sm btn-primary " href="{{ route('sesiones.show', $sesione->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                <a class="btn btn-sm btn-success" href="{{ route('sesiones.edit', $sesione->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                @csrf
                                                @method('DELETE')
